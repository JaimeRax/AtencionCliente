...
public class Empresa_Sucursal extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        Empresa emp = new Empresa(txtNombreEmpresa.getText());
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        ...
        if(suc == null)
        {
            ...
            if(co.deleteUpdate(Integer.parseInt(txtCodigo.getText()))){
    ...
    private void btnGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardar1ActionPerformed
        ...
        Sucursal suc = new Sucursal(txtNombreSucursal.getText(),
        ...
        if(bandera == 2){
        int id = Integer.parseInt(txtCodigoSucursal.getText());
        if(!co.updateSucursal(suc,id))
        { 
    ...
    private void btnBorrar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrar1ActionPerformed
        ...
        if(usu==null){
            ...
            if(co.deleteUpdateSucursal(Integer.parseInt(txtCodigoSucursal.getText())))
            {
